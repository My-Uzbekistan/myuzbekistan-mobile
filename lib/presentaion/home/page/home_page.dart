                        ...
                        if (state.selectedRegion != null)
                          Padding(
                            ...
                            child: HomeRegionCard(
                              ...
                              onTap: () {
                                context.pushSelectRegionPage(
                                    state.regions, state.selectedRegion!.id);
                              },
                            ),
                          ),
                        CategoryHeader(
...
class CategoryHeader extends StatefulWidget {
  ...
  const CategoryHeader(
      {required this.categories, this.onItemTap, this.scrollController});
