...
mixin _$GiftBlocState {
 ...
 bool get isLoading; bool get giftEnabled; dynamic get haveGift; ClaimStatus? get claimStatus; int? get activeStatusCode; dynamic get giftActivated; ClaimHistory? get activeClaim; List<ClaimHistory> get items; String? get errorMessage;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GiftBlocState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.giftEnabled, giftEnabled) || other.giftEnabled == giftEnabled)&&const DeepCollectionEquality().equals(other.haveGift, haveGift)&&(identical(other.claimStatus, claimStatus) || other.claimStatus == claimStatus)&&(identical(other.activeStatusCode, activeStatusCode) || other.activeStatusCode == activeStatusCode)&&const DeepCollectionEquality().equals(other.giftActivated, giftActivated)&&(identical(other.activeClaim, activeClaim) || other.activeClaim == activeClaim)&&const DeepCollectionEquality().equals(other.items, items)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}


@override
int get hashCode => Object.hash(runtimeType,isLoading,giftEnabled,const DeepCollectionEquality().hash(haveGift),claimStatus,activeStatusCode,const DeepCollectionEquality().hash(giftActivated),activeClaim,const DeepCollectionEquality().hash(items),errorMessage);

@override
String toString() {
  return 'GiftBlocState(isLoading: $isLoading, giftEnabled: $giftEnabled, haveGift: $haveGift, claimStatus: $claimStatus, activeStatusCode: $activeStatusCode, giftActivated: $giftActivated, activeClaim: $activeClaim, items: $items, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 bool isLoading, bool giftEnabled, dynamic haveGift, ClaimStatus? claimStatus, int? activeStatusCode, dynamic giftActivated, ClaimHistory? activeClaim, List<ClaimHistory> items, String? errorMessage
});
...
/// Create a copy of GiftBlocState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isLoading = null,Object? giftEnabled = null,Object? haveGift = freezed,Object? claimStatus = freezed,Object? activeStatusCode = freezed,Object? giftActivated = freezed,Object? activeClaim = freezed,Object? items = null,Object? errorMessage = freezed,}) {
  return _then(_self.copyWith(
isLoading: null == isLoading ? _self.isLoading : isLoading // ignore: cast_nullable_to_non_nullable
as bool,giftEnabled: null == giftEnabled ? _self.giftEnabled : giftEnabled // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  bool giftEnabled,  dynamic haveGift,  ClaimStatus? claimStatus,  int? activeStatusCode,  dynamic giftActivated,  ClaimHistory? activeClaim,  List<ClaimHistory> items,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GiftBlocState() when $default != null:
return $default(_that.isLoading,_that.giftEnabled,_that.haveGift,_that.claimStatus,_that.activeStatusCode,_that.giftActivated,_that.activeClaim,_that.items,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isLoading,  bool giftEnabled,  dynamic haveGift,  ClaimStatus? claimStatus,  int? activeStatusCode,  dynamic giftActivated,  ClaimHistory? activeClaim,  List<ClaimHistory> items,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _GiftBlocState():
return $default(_that.isLoading,_that.giftEnabled,_that.haveGift,_that.claimStatus,_that.activeStatusCode,_that.giftActivated,_that.activeClaim,_that.items,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isLoading,  bool giftEnabled,  dynamic haveGift,  ClaimStatus? claimStatus,  int? activeStatusCode,  dynamic giftActivated,  ClaimHistory? activeClaim,  List<ClaimHistory> items,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _GiftBlocState() when $default != null:
return $default(_that.isLoading,_that.giftEnabled,_that.haveGift,_that.claimStatus,_that.activeStatusCode,_that.giftActivated,_that.activeClaim,_that.items,_that.errorMessage);case _:
  return null;
...
class _GiftBlocState implements GiftBlocState {
   _GiftBlocState({this.isLoading = true, this.giftEnabled = false, this.haveGift = false, this.claimStatus, this.activeStatusCode, this.giftActivated = false, this.activeClaim, final  List<ClaimHistory> items = const [], this.errorMessage}): _items = items;
  

@override@JsonKey() final  bool isLoading;
@override@JsonKey() final  bool giftEnabled;
...
@override
int get hashCode => Object.hash(runtimeType,isLoading,giftEnabled,const DeepCollectionEquality().hash(haveGift),claimStatus,activeStatusCode,const DeepCollectionEquality().hash(giftActivated),activeClaim,const DeepCollectionEquality().hash(_items),errorMessage);
...
/// Create a copy of GiftBlocState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isLoading = null,Object? giftEnabled = null,Object? haveGift = freezed,Object? claimStatus = freezed,Object? activeStatusCode = freezed,Object? giftActivated = freezed,Object? activeClaim = freezed,Object? items = null,Object? errorMessage = freezed,}) {
