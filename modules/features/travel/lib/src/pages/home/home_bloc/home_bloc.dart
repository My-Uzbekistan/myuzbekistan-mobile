...
class HomeBloc extends Bloc<HomeBlocEvent, HomeBlocState> {
  ...
  Future<void> _loadContentsEvent(
    ...
    try {
      ...
      final result = await Future.wait({contentFuture, weatherFuture});
