...
return checkPermission(_that);case _LoadPayerTimes() when loadPrayerTimes != null:
...
return loadBanners(_that);case _LoadHomeBackgroundEvent() when loadHomeBackground != null:
return loadHomeBackground(_that);case _LoadHotelsEvent() when loadHotels != null:
...
return checkPermission(_that);case _LoadPayerTimes():
...
return loadBanners(_that);case _LoadHomeBackgroundEvent():
return loadHomeBackground(_that);case _LoadHotelsEvent():
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function( bool isRefresh)?  loadDataEvent,TResult Function( int regionId)?  changeRegion,TResult Function()?  loadContents,TResult Function()?  checkPermission,TResult Function()?  loadPrayerTimes,TResult Function()?  loadWeather,TResult Function()?  loadServices,TResult Function()?  loadCities,TResult Function()?  loadBanners,TResult Function()?  loadHomeBackground,TResult Function()?  loadHotels,TResult Function()?  loadEvents,TResult Function()?  loadAirQuality,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HomeBlocInitialEvent() when initial != null:
...
return checkPermission();case _LoadPayerTimes() when loadPrayerTimes != null:
...
return loadBanners();case _LoadHomeBackgroundEvent() when loadHomeBackground != null:
return loadHomeBackground();case _LoadHotelsEvent() when loadHotels != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function( bool isRefresh)  loadDataEvent,required TResult Function( int regionId)  changeRegion,required TResult Function()  loadContents,required TResult Function()  checkPermission,required TResult Function()  loadPrayerTimes,required TResult Function()  loadWeather,required TResult Function()  loadServices,required TResult Function()  loadCities,required TResult Function()  loadBanners,required TResult Function()  loadHomeBackground,required TResult Function()  loadHotels,required TResult Function()  loadEvents,required TResult Function()  loadAirQuality,}) {final _that = this;
switch (_that) {
case _HomeBlocInitialEvent():
...
return checkPermission();case _LoadPayerTimes():
...
return loadBanners();case _LoadHomeBackgroundEvent():
return loadHomeBackground();case _LoadHotelsEvent():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function( bool isRefresh)?  loadDataEvent,TResult? Function( int regionId)?  changeRegion,TResult? Function()?  loadContents,TResult? Function()?  checkPermission,TResult? Function()?  loadPrayerTimes,TResult? Function()?  loadWeather,TResult? Function()?  loadServices,TResult? Function()?  loadCities,TResult? Function()?  loadBanners,TResult? Function()?  loadHomeBackground,TResult? Function()?  loadHotels,TResult? Function()?  loadEvents,TResult? Function()?  loadAirQuality,}) {final _that = this;
switch (_that) {
case _HomeBlocInitialEvent() when initial != null:
return initial();case _LoadDataEvent() when loadDataEvent != null:
return loadDataEvent(_that.isRefresh);case _ChangeRegion() when changeRegion != null:
...
class _LoadHomeBackgroundEvent with DiagnosticableTreeMixin implements HomeBlocEvent {
   _LoadHomeBackgroundEvent();
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'HomeBlocEvent.loadHomeBackground'))
    ;
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoadHomeBackgroundEvent);
}
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'HomeBlocEvent.loadHomeBackground()';
}
...
@JsonKey() final  bool loadingBackground;
...
as List<BannerItem>,backgroundImage: freezed == backgroundImage ? _self.backgroundImage : backgroundImage // ignore: cast_nullable_to_non_nullable
as String?,loadingBackground: null == loadingBackground ? _self.loadingBackground : loadingBackground // ignore: cast_nullable_to_non_nullable
as bool,hotels: null == hotels ? _self._hotels : hotels // ignore: cast_nullable_to_non_nullable
...
as List<Region>,prayerTimes: freezed == prayerTimes ? _self.prayerTimes : prayerTimes // ignore: cast_nullable_to_non_nullable
as PrayerTimes?,selectedRegion: freezed == selectedRegion ? _self.selectedRegion : selectedRegion // ignore: cast_nullable_to_non_nullable
