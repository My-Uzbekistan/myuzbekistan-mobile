  ...
  static final routes = [
    ...
    GoRoute(
      ...
      pageBuilder: (context, state) => buildSlideTransitionPage(
          child: BlocProvider.value(value: state.extra as ProfileBloc,child: ProfilePage(),), context: context, state: state),
    ),
    GoRoute(
  ...
  static final shellMore = StatefulShellBranch(
    routes: [
      GoRoute(
          ...
          builder: (context, state) => BlocProvider(create: (ctx)=>getIt<ProfileBloc>()..add(ProfileBlocEvent.initEvent()),
          child: ShellMorePage(),
          )),
